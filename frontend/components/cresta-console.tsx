    ...
    try {
      ...
      const route = await llmApi.createShadowRoute(
        ...
        draft.failurePolicy === "FAILOVER" ? draft.fallbackModelId : null,
        {
          ...
          timeoutMs: Number(draft.timeoutSeconds || "30") * 1000,
