...
def _response(
    ...
    return AgentRunResponse(
        ...
        basis_decision_id=run.basis_decision_id,
        fusion_policy_version=run.fusion_policy_version,
        fusion_state=run.fusion_state,
        fusion_reason_code=run.fusion_reason_code,
        fusion_decision_id=run.fusion_decision_id,
