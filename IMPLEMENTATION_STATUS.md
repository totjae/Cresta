...
| Web UI | `docs/WEB_UI_SPEC.md` | 구현 중 | 인증 Console, 감시 종목·Paper 조회·Broker 진단·실행 권한·SHADOW 단계와 AI scheduler 상태 표시 구현; 승인 카드·Guard 상세 결과 미구현 |
...
| Scout·Core AI 계약 | `docs/AI_DECISION_SPEC.md` | 구현 중 | `deterministic-mock-v1` 진단과 KST 정기 TRADING scheduler·SHADOW 인계 구현; 실제 AI provider와 보유 포지션 판단 미구현 |
